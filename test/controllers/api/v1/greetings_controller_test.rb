...
class Api::V1::GreetingsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create api_v1_greeting" do
    assert_difference("Api::V1::Greeting.count") do
      post api_v1_greetings_url, params: { api_v1_greeting: { messagee: @api_v1_greeting.messagee } }, as: :json
    end
  ...
  test "should update api_v1_greeting" do
    patch api_v1_greeting_url(@api_v1_greeting), params: { api_v1_greeting: { messagee: @api_v1_greeting.messagee } }, as: :json
    assert_response :success
  end
